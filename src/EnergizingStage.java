/**
 * Represents the Energizing growth stage of a plant
 *
 * - The plant should not be watered
 * - Watering prevents progression
...
public class EnergizingStage implements GrowthStage {
     ...
     * @return true only if the plant was NOT watered
     */
    @Override
    public boolean canAdvance(boolean isWatered) {
        return !isWatered; // watering here stops the growth of the plant
    }
     ...
     *
     * @return false since energizing plants cannot be harvested
     */
    @Override
